...
1. Objective
This project creates a simplified data warehouse for analyzing users, credit cards, companies, products, and financial transactions. The goal is to perform analytical queries using a star schema structure.
...
3. Foreign Keys for Star Schema
